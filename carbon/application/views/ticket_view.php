    ...
    <div class="headerContainer">
        ...
        <div id="navcontainer">
            <ul id="navlist">
                ...
                <li id="active"><a href="http://10.151.34.9/fpsavekbs/CodeIgniter/index.php/home/ticket">Buy Ticket</a></li>
            </ul>
        </div>
...
<h1></h1>
            ...
            <div class="clearfloat"></div>
        <div class="boxes">
            <a href="reservasi"><img src="../../images/shopping_bag2.png" alt=""></a>
            <a href="reservasi"><img src="../../images/forward.png" alt=""></a>
            <div class="clearfloat"></div>
            </div>
            <!-- end Right List -->
            </div>
