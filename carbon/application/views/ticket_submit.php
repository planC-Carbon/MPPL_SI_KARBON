...
<title>Kebun Binatang Surabaya - Reservasi Tiket</title>
    ...
    <div class="headerContainer">
        ...
        <div id="navcontainer">
            <ul id="navlist">
                ...
                <li id="active"><a href="http://10.151.34.9/fpsavekbs/CodeIgniter/index.php/home/reservasi">Buy Ticket</a></li>
            </ul>
        </div>
...
<footer>
    ...
    <div class="footerBody">
        ...
        <h1>Terima Kasih telah mengisi Reservasi Tiket Online Kebun Binatang Surabaya.<br />
Silahkan tunggu email dari kami...</h1><br>
        </div>
        </div>
<h1></h1>
